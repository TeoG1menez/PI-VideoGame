...
- [ listo] Videojuego con las siguientes propiedades:
  ...
  - Rating
  - Plataformas *
- [ listo] Genero con las siguientes propiedades:
  - ID
  - Nombre
...
- [ listo] __GET /videogames__:
  - Obtener un listado de los videojuegos
  - Debe devolver solo los datos necesarios para la ruta principal
- [ listo] __GET /videogames?name="..."__:
